...
//                    list.get(position).getIcon(), viewholder.iv_pic);
        ...
        viewholder.iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = ((OrderActivity)context).getSelectedItemCountById(list.get(position).getProduct_id());
                ...
                ((OrderActivity)context).handlerCarNum(1,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
        ...
        viewholder.iv_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((OrderActivity)context).handlerCarNum(0,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
